        ...
        public override MetadataFileResult MovieMetadata(Movie movie, MovieFile movieFile)
        {
            ...
            if (Settings.MovieMetadata)
            {
                ...
                if (movieFile.MediaInfo != null)
                {
                    ...
                    video.Add(new XElement("codec", MediaInfoFormatter.FormatVideoCodecForKodiMetadata(movieFile.MediaInfo)));
                    ...
                    audio.Add(new XElement("codec", MediaInfoFormatter.FormatAudioCodecForKodiMetadata(movieFile.MediaInfo)));
